...
//
//        mTimeTable = findViewById(R.id.time_table);
//        mTimeTable.setTableMode(TimeTableView.TableMode.LONG);
//        mTimeTable.setShowHeader(true);
//
//        TimeData timeData = new TimeData(1, "English", R.color.color_gray, R.color.white, getMillis("2017-11-10 07:30:00"), getMillis("2017-11-10 08:55:00"));
//
//        mTimeTable.setTimeTable(getMillis("2017-11-10 00:00:00"), mLongSamples);
//    }
//
//    private long getMillis(String dateString) {
    ...
    private void initListener() {
        ...
        timeTable.setOnTimeItemClickListener(new TimeTableItemViewHolder.OnTimeItemClickListener() {
            ...
            public void onTimeItemClick(View view, int position, TimeGridData item) {
                ...
                showToast(TimeTableActivity.this,
